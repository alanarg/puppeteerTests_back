...
const criarSecao = async (req,page,i,c) =>{
    ...
    const entradas = req;
            ...
            await page.screenshot({path:`./src/public/PESQUISAMS_IMAGES/criarsecao_${i}.jpg`, fullPage:true}).then(t=>{
                obj.print = `${process.env.URL_SYSTEM}/PESQUISAMS_IMAGES/criarsecao_${i}.jpg`;
            });
